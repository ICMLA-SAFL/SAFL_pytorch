...
class BaseTrainer(object):
  ...
  def train(self, epoch, data_loader, optimizer, current_lr=0.0, 
    ...
    for i, inputs in enumerate(data_loader):
      ...
      self.model.train()
      self.iters += 1
      # optimizer.param_groups[0]['lr'] = (1.0/(512.0**0.5))*min(1.0/float(self.iters)**0.5, float(self.iters)*1.0/16000.0**1.5)
      ...
      for param_group in optimizer.param_groups:
        param_group['lr'] = (1.0/(512.0**0.5))*min(1.0/float(self.iters)**0.5, float(self.iters)*1.0/16000.0**1.5) 
