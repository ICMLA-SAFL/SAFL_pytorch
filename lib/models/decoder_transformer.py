...
class DecoderUnit(nn.Module):
  def __init__(self, sDim, xDim, yDim, attDim, num_encoders, num_decoders):
    ...
    self.decoder = Transformer(d_model=512, nhead=8, num_encoder_layers=num_encoders,num_decoder_layers=num_decoders, dim_feedforward=2048)
  ...
  def forward(self, x, sPrev, yPrev):
    ...
    # print("src_mask: ", self.src_mask.size())
    # print(" ",self.target_mask.size()) 
