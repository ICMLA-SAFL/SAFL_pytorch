...
parser.add_argument('--real_train_data_dir', type=str, metavar='PATH',
                    default='/home/aimenext2/manhnh/aster.pytorch/data/lmdb/')
...
parser.add_argument('--encoder_block', type=int, default= 4)
parser.add_argument('--decoder_block', type=int, default= 4)
## lstm
